...
my $obj = Game::3D::Physical->new ( );

is (ref($obj), 'Game::3D::Physical', 'new worked');
...
is ($obj->shape(), GAME_3D_CUBE, 'shaped like a cube');
...
$obj = Game::3D::Physical->new ( mass => 90 );
is (ref($obj), 'Game::3D::Physical', 'new worked');
