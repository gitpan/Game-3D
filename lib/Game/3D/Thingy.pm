...
Game::3D::Thingy - base class for virtual and physical 3D objects

=head1 SYNOPSIS

	package Game::3D::MyThingy;

	use Game::3D::Thingy;
	require Exporter;

	@ISA = qw/Game::3D::Thingy/;
...
This package provides a base class for "things" in Game::3D. It should
...
=item new()
	...
	my $thingy = Game::3D::Thingy->new(@options);
	my $thingy = Game::3D::Thingy->new( $options );	# hash ref w/ options
...
everyone. Important for Game::3D::Link, though.
...
Game::3D::Link object, do not forget to also register the
...
L<Game::3D>, L<SDL:App::FPS>, L<SDL::App> and L<SDL>.
